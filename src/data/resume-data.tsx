...
export function getResumeData(t: (k: string, data?: any) => string) {
  return {
    ...
    work: [
      {
        company: "Amaris",
        link: "https://amaris.com/",
        badges: [t('work.amaris.badges.0'),t('work.amaris.badges.1'),  t('work.amaris.badges.2')],
        title: t("work.amaris.title"),
        logo: Emoko,
        start: "2024",
        end: "now",
        description: t("work.amaris.description"),
      },
      {
        company: "Emoko",
        link: "https://emoko.io",
      ...
      },
      {
        ...
        badges: [t('work.wiztivi.badges.0'),t('work.wiztivi.badges.1')],
