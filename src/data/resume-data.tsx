    ...
    projects: [
      {
        ...
        description: `Application WEB pour visiter et configurer des logements en réalité virtuelle. 
        Rendus précalculés de manière automatique sur un seveur dédié (GCP)`,
        logo: ConsultlyLogo,
        link: {
          label: "emoko",
          href: "https://emoko.io",
